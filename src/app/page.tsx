...
export default function HomePage() {
  ...
  const stats = [
    ...
    { icon: <Award className="h-8 w-8" />, number: "95%", label: "Job Placement Rate", description: "Within 6 months" },
    {
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <Badge className="mb-6 bg-black/10 text-black border-black/20 text-lg px-6 py-2">
              🚀 The Future is Now - Join 15,000+ Developers
            </Badge>
            ...
            >
              <Button size="lg" className="gradient-bg text-white font-semibold text-lg px-8 py-4 neon-glow">
                Explore Courses
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                className="border-1 border-black text-black hover:bg-black hover:text-white text-lg px-8 py-4 bg-transparent"
              >
              ...
              >
                <Card className="bg-white border-gray-200 hover:border-black/50 transition-all duration-300 h-full shadow-sm group">
                  <CardContent className="p-8 text-center">
                    <div className="text-black mb-6 flex justify-center group-hover:scale-110 transition-transform duration-300">
                      {feature.icon}
                    </div>
                ...
                <Card className="bg-white border-gray-200 hover:border-black/50 transition-all duration-300 h-full shadow-sm">
                  <div className="relative overflow-hidden">
                    <Image
                      ...
                      height={400}
                    />
                    <Badge className="absolute top-4 left-4 bg-green-600 text-black">Popular</Badge>
                  </div>
                  <CardContent className="p-6">
                    <h3 className="text-xl font-semibold text-black mb-3">{course.title}</h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button className="gradient-bg text-white">Enroll Now</Button>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="bg-white border-gray-200 text-center shadow-sm">
                  <CardContent className="p-8">
                    ...
                    <p className="text-black mb-2">{instructor.role}</p>
                ...
                <Card className="bg-white border-gray-200 shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <Badge className="bg-black text-white">{event.type}</Badge>
                    ...
                    <Button className="w-full gradient-bg text-white">Register Free</Button>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-black mb-2">Start Learning</h3>
                  <p className="text-gray-600 text-sm">Choose your course and begin your journey</p>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-sm">
                    <Users className="h-8 w-8 text-black" />
                  </div>
                  <h3 className="font-semibold text-black mb-2">Build Projects</h3>
                  <p className="text-gray-600 text-sm">Create real-world applications with mentorship</p>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-sm">
                    <Briefcase className="h-8 w-8 text-black" />
                  </div>
                  <h3 className="font-semibold text-black mb-2">Land Your Job</h3>
                  <p className="text-gray-600 text-sm">Get hired at top tech companies</p>
                </div>
              </div>
